...
num1 = 1
st = ''
fio1 = open('Imaginative1.csv','w')
fio2 = open('Imaginativelist1.txt','w')
def main():
	global s
	global fio1
...
def saving(e):
	...
	#	print extra1
		temp = line.split(',')
		t = 1
		if e == 'ISTJ' or e == 'ISFJ' or e == 'ISTP' or e == 'ISFP' or e == 'ESTJ' or e == 'ESFJ' or e == 'ESTP' or e == 'ESFP':
			st = str(num1)+','+ '0'
		else:
			st = str(num1) + ',' +'1'
		num1 = num1 + 1
